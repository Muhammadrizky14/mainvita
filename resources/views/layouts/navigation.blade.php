        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-8 sm:flex sm:items-center">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-700 hover:text-blue-600 focus:outline-none focus:text-blue-600 transition duration-150 ease-in-out {{ request()->routeIs('spa.index') || request()->routeIs('yoga.index') || request()->routeIs('event.index') ? 'text-blue-600' : '' }}"
