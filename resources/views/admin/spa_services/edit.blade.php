...
<div class="container mx-auto px-2 sm:px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center mb-6 gap-2">
            <h1 class="text-2xl font-bold">Edit Service for {{ $spa->nama }}</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <form action="{{ route('admin.spas.services.update', [$spa->id_spa, $service->id]) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition">{{ old('description', $service->description) }}</textarea>
                </div>
