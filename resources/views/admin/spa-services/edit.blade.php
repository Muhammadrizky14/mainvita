...
<div class="container mx-auto px-4">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.spas.services.update', [$spa->id_spa, $service->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description', $service->description) }}</textarea>
                </div>
